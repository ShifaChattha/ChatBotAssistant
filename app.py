...
# #It connects my app to Google’s AI using the API key.
...
# greetings_reply = "Hello! 🌸 I am your NARS Assistant. How can I help you with NARS products, beauty tips, or orders?"

# # --- Detect relevant knowledge ---
# def get_relevant_knowledge(user_message):
#     user_message_lower = user_message.lower()

#     # 1️⃣ Check JSON knowledge first
#     for key, content in knowledge_base.items():
#         for kw in content.get("keywords", []):
#             if kw.lower() in user_message_lower:
#                 return {key: content}

#     # 2️⃣ Then check product keywords (DB)
...
#     # 3️⃣ Default: return full knowledge
...
# --- Load all products once at server start ---
all_products_data = get_products_from_db()

# --- Simple greetings ---
greetings = ["hello", "hey", "aoa", "asalamu-alikum"]
greetings_reply = "Hello! 🌸 I am your NARS Assistant. How can I help you with NARS products, beauty tips, or orders?"
...
def get_relevant_knowledge(user_message):
    ...
    # 2️⃣ Default: return JSON knowledge (without DB query)
    return knowledge_base
...
def chat():
    ...
    # ✅ Always include DB products for GPT reference
    relevant_knowledge["products"] = all_products_data
